...
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws IOException {
         ...
         */
    	MainApp.setScene("AccountManager", null);
    	
    	stage.setTitle("Sapphire Horizon Bank Application");
    	stage.setWidth(800);
        stage.setHeight(600);
    ...
    @Override
    public void stop() {
    	CommonMethods.saveDataToCSV();
    	CommonMethods.showSuccessAlert("Thank you for visiting, see you again soon...!");
    }
